...
var _default = {
  global: {
    ...
    descripcionCurso: 'Es a través del lenguaje estructurado de consulta SQL que se puede acceder a la creación, gestión y administración de las bases de datos, a partir del uso de sentencias y comandos que nos facilitan la interacción con las bases de datos relacionales.',
